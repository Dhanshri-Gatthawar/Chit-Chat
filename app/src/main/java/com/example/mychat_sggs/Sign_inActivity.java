...
import com.example.mychat_sggs.databinding.ActivitySignInBinding;
...
public class Sign_inActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Sign_inActivity.this);
                ...
                auth.signInWithEmailAndPassword(binding.etEmail.getText().toString(), binding.etPassword.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Sign_inActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(Sign_inActivity.this , MainActivity.class);
                            startActivity(intent);
                            Toast.makeText(Sign_inActivity.this, "sign in with google", Toast.LENGTH_SHORT).show();
                           // updateUI(user);
                        } else {
